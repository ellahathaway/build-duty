...
//                     .GroupBy(i => i.Sources.FirstOrDefault()?.SourceType)
//                     .OrderBy(g => g.Key)
...
//             return $"""
//                 - **{item.Id}**
//                                     Type: {FormatType(sourceRef?.SourceType)}
//                   Status: {item.Status}
//                   Title: {item.Title}
...
//     private static string FormatType(SignalSource? type) => type switch
//     {
//         SignalSource.AzureDevOpsPipeline => "Pipeline Failures",
//         SignalSource.GitHubIssue => "GitHub Issues",
//         SignalSource.GitHubPr => "GitHub PRs",
//         _ => "(unknown)",
//     };
...
//     private sealed record ItemGroup(SignalSource? Type, string Status, List<WorkItem> Items);
// }
